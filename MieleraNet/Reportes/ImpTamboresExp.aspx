<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImpTamboresExp.aspx.cs" Inherits="MieleraNet.Reportes.ImpTamboresExp" %>
...
<head runat="server">
    <title>Tambores</title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
        <dx:reporttoolbar id="rtTamboresExp" runat="server" reportviewer="<%# rvTamboresExp %>"
...
<Margins MarginLeft="3px" MarginRight="3px"></Margins>
        ...
        <dx:reportviewer id="rvTamboresExp" runat="server"></dx:reportviewer>
    </form>
</body>
</html>
